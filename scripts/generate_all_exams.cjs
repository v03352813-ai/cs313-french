...
const ALL_PAPERS = [
  ...
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(101, 'kaoyan', '名校考研二外', '北京外国语大学', '2024真题卷',
    '2024年北京外国语大学 二外法语考研统考真题卷',
    'Université des Études Étrangères de Pékin (BFSU) — Session 2024',
    '北外官方命题风格：词汇辨析精妙、动词变位严谨、代词多重替换与法国社会发展长篇综合考核。', 75, true),
  buildAuthenticFullPaper(102, 'kaoyan', '名校考研二外', '北京外国语大学', '2023真题卷',
    '2023年北京外国语大学 二外法语考研统考真题卷',
    'Université des Études Étrangères de Pékin (BFSU) — Session 2023',
    '北外2023权威统考试卷：重点考查虚拟式让步与情感从句、复合过去时配合陷阱及哲学伦理读解。', 75, false),
  buildAuthenticFullPaper(103, 'kaoyan', '名校考研二外', '北京外国语大学', '2022真题卷',
    '2022年北京外国语大学 二外法语考研统考真题卷',
    'Université des Études Étrangères de Pékin (BFSU) — Session 2022',
    '沉淀北外十年真题题源：副代词 y/en 与间宾代词复杂句式、否定副词文学用法及社科长文。', 75, false),
  buildAuthenticFullPaper(104, 'kaoyan', '名校考研二外', '北京外国语大学', '2021真题卷',
    '2021年北京外国语大学 二外法语考研统考真题卷',
    'Université des Études Étrangères de Pékin (BFSU) — Session 2021',
    '北外2021真题原卷复原：时态呼应逻辑严密、自反代词分词配合、完形填空动词介词搭配。', 75, false),
  buildAuthenticFullPaper(105, 'kaoyan', '名校考研二外', '北京外国语大学', '2020真题卷',
    '2020年北京外国语大学 二外法语考研统考真题卷',
    'Université des Études Étrangères de Pékin (BFSU) — Session 2020',
    '北外2020统考真题：高频考查条件式假设系统、中性代词 le 替代从句及文化多样性长篇精读。', 75, false),
  buildAuthenticFullPaper(106, 'kaoyan', '名校考研二外', '北京外国语大学', '2019真题卷',
    '2019年北京外国语大学 二外法语考研统考真题卷',
    'Université des Études Étrangères de Pékin (BFSU) — Session 2019',
    '北外2019统考真题：二外法语自命题经典风格，词汇量要求扎实，语法改错防坑重点。', 75, false),
  buildAuthenticFullPaper(107, 'kaoyan', '名校考研二外', '北京外国语大学', '经典必考卷',
    '北京外国语大学 二外法语历年必考压轴经典真题精选卷',
    'BFSU : Recueil d\'excellence des annales classiques de français',
    '沉淀北外历年考研最具代表性的核心试题，语法攻坚与高难度阅读理解集训。', 75, false),
  buildAuthenticFullPaper(108, 'kaoyan', '名校考研二外', '北京外国语大学', '2025高频冲刺',
    '2025年北京外国语大学 二外法语考研全真模拟冲刺卷',
    'BFSU : Modèle national d\'entraînement intensif pour Master 2025',
    '基于北外最新命题大纲趋势研发，贴合最新时政与学术法语词汇，临考自测利器。', 75, false),

  // -----------------------------------------------------------------------
  // 二、上海外国语大学 二外法语历年统考真题与冲刺系列 (8套)
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(111, 'kaoyan', '名校考研二外', '上海外国语大学', '2024真题卷',
    '2024年上海外国语大学 二外法语考研统考真题卷',
    'Université des Études Internationales de Shanghai (SISU) — Session 2024',
    '上外经典卷面：语法注重时态配合逻辑，完形填空考察虚词短语搭配，长篇论说文立意深远。', 75, false),
  buildAuthenticFullPaper(112, 'kaoyan', '名校考研二外', '上海外国语大学', '2023真题卷',
    '2023年上海外国语大学 二外法语考研统考真题卷',
    'Université des Études Internationales de Shanghai (SISU) — Session 2023',
    '上外2023统考原卷精编：主句从句虚拟式判定、关系代词 dont/lequel 复合搭配、汉译法题源。', 75, false),
  buildAuthenticFullPaper(113, 'kaoyan', '名校考研二外', '上海外国语大学', '2022真题卷',
    '2022年上海外国语大学 二外法语考研统考真题卷',
    'Université des Études Internationales de Shanghai (SISU) — Session 2022',
    '上外高频考卷：代词式动词间宾不配合考点、先将来时与简单将来时时态呼应、社科精读。', 75, false),
  buildAuthenticFullPaper(114, 'kaoyan', '名校考研二外', '上海外国语大学', '2021真题卷',
    '2021年上海外国语大学 二外法语考研统考真题卷',
    'Université des Études Internationales de Shanghai (SISU) — Session 2021',
    '上外2021真题：突出动词短语介词接格 (à / de)、原因让步从句连词辨析、长篇事实推论。', 75, false),
  buildAuthenticFullPaper(115, 'kaoyan', '名校考研二外', '上海外国语大学', '2020真题卷',
    '2020年上海外国语大学 二外法语考研统考真题卷',
    'Université des Études Internationales de Shanghai (SISU) — Session 2020',
    '上外2020自命题真题：双宾语代词位置、条件式过去时表达遗憾、法国生态转型长文。', 75, false),
  buildAuthenticFullPaper(116, 'kaoyan', '名校考研二外', '上海外国语大学', '2019真题卷',
    '2019年上海外国语大学 二外法语考研统考真题卷',
    'Université des Études Internationales de Shanghai (SISU) — Session 2019',
    '上外经典真题：考察时态严谨度、否定结构变 de 规则、法国当代教育改革批判。', 75, false),
  buildAuthenticFullPaper(117, 'kaoyan', '名校考研二外', '上海外国语大学', '经典必考卷',
    '上海外国语大学 二外法语历年语法与读解压轴必考卷',
    'SISU : Annales sélectionnées et structures grammaticales fondamentales',
    '汇集上外近十年考研最具区分度的高分考题，冲刺 90+ 必备经典大卷。', 75, false),
  buildAuthenticFullPaper(118, 'kaoyan', '名校考研二外', '上海外国语大学', '2025高频冲刺',
    '2025年上海外国语大学 二外法语考研全真模拟冲刺卷',
    'SISU : Épreuve de simulation approfondie pour le Concours 2025',
    '针对上外自命题风格最新演化趋势研发，深度模拟考场环境与答题节奏。', 75, false),

  // -----------------------------------------------------------------------
  // 三、广东外语外贸大学 二外法语历年统考真题与冲刺系列 (8套)
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(121, 'kaoyan', '名校考研二外', '广东外语外贸大学', '2024真题卷',
    '2024年广东外语外贸大学 二外法语考研真题卷',
    'Université des Études Étrangères du Guangdong (GDUFS) — Session 2024',
    '广外二外大纲命题：注重商务与日常交际法文、虚拟式判断、双宾语代词位置及阅读细节推断。', 60, false),
  buildAuthenticFullPaper(122, 'kaoyan', '名校考研二外', '广东外语外贸大学', '2023真题卷',
    '2023年广东外语外贸大学 二外法语考研真题卷',
    'Université des Études Étrangères du Guangdong (GDUFS) — Session 2023',
    '广外2023统考真题：高频考查愈过去时配合、形容词最高级后虚拟式从句、商务邮件阅读。', 60, false),
  buildAuthenticFullPaper(123, 'kaoyan', '名校考研二外', '广东外语外贸大学', '2022真题卷',
    '2022年广东外语外贸大学 二外法语考研真题卷',
    'Université des Études Étrangères du Guangdong (GDUFS) — Session 2022',
    '广外2022真题：复合关系代词 lequel 介词缩合、国名前介词 au/en 区分、职场阅读分析。', 60, false),
  buildAuthenticFullPaper(124, 'kaoyan', '名校考研二外', '广东外语外贸大学', '2021真题卷',
    '2021年广东外语外贸大学 二外法语考研真题卷',
    'Université des Études Étrangères du Guangdong (GDUFS) — Session 2021',
    '广外2021真题：时态未完成过去时充当背景、副代词 en 的数量替代、当代科技思辨读解。', 60, false),
  buildAuthenticFullPaper(125, 'kaoyan', '名校考研二外', '广东外语外贸大学', '2020真题卷',
    '2020年广东外语外贸大学 二外法语考研真题卷',
    'Université des Études Étrangères du Guangdong (GDUFS) — Session 2020',
    '广外2020真题：动词变位特异词根、直宾提前分词配合、完形填空固定介词搭配集训。', 60, false),
  buildAuthenticFullPaper(126, 'kaoyan', '名校考研二外', '广东外语外贸大学', '2019真题卷',
    '2019年广东外语外贸大学 二外法语考研真题卷',
    'Université des Études Étrangères du Guangdong (GDUFS) — Session 2019',
    '广外经典真题：强调语言实用性与规范性，完形填空语感考查、长篇社科阅读事实推断。', 60, false),
  buildAuthenticFullPaper(127, 'kaoyan', '名校考研二外', '广东外语外贸大学', '经典必考卷',
    '广东外语外贸大学 二外法语大纲高频考点必刷卷',
    'GDUFS : Recueil intensif des points clés du programme officiel',
    '系统梳理广外历届统考必刷题型，击破华南名校二外核心易错点。', 60, false),
  buildAuthenticFullPaper(128, 'kaoyan', '名校考研二外', '广东外语外贸大学', '2025高频冲刺',
    '2025年广东外语外贸大学 二外法语考研全真模拟冲刺卷',
    'GDUFS : Épreuve nationale de simulation pour Master 2025',
    '紧扣广外最新考试大纲方向研发，全真还原答题时间与题型难度。', 60, false),

  // -----------------------------------------------------------------------
  // 四、985名校联盟系列 (南大/武大/复旦/中大 10套)
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(131, 'kaoyan', '名校考研二外', '南京大学', '2024统考卷',
    '2024年南京大学 二外法语考研统考真题卷',
    'Université de Nanjing (NJU) — Épreuve de français langue seconde 2024',
    '南大外院命题风格：强调文学性与正统学术法语，分词配合与虚拟式触发机制考察细致入微。', 60, false),
  buildAuthenticFullPaper(132, 'kaoyan', '名校考研二外', '南京大学', '2023统考卷',
    '2023年南京大学 二外法语考研统考真题卷',
    'Université de Nanjing (NJU) — Épreuve de français langue seconde 2023',
    '南大2023真题：时态严谨配合、复杂主从句关系代词引导、法国哲学与艺术长文。', 60, false),
  buildAuthenticFullPaper(133, 'kaoyan', '名校考研二外', '南京大学', '2022统考卷',
    '2022年南京大学 二外法语考研统考真题卷',
    'Université de Nanjing (NJU) — Épreuve de français langue seconde 2022',
    '南大2022经典真题：自反动词性数配合避坑、被动语态复合时态、高难度阅读推理。', 60, false),

  buildAuthenticFullPaper(134, 'kaoyan', '名校考研二外', '武汉大学', '2024精编卷',
    '2024年武汉大学 二外法语考研真题精编卷',
    'Université de Wuhan (WHU) — Épreuve officielle de français 2024',
    '武大经典二外：涵盖动词短语搭配、条件式假设句型、介词用法辨析与现代法国社会长篇精读。', 60, false),
  buildAuthenticFullPaper(135, 'kaoyan', '名校考研二外', '武汉大学', '2023精编卷',
    '2023年武汉大学 二外法语考研真题精编卷',
    'Université de Wuhan (WHU) — Épreuve officielle de français 2023',
    '武大2023真题：副代词 y/en 在肯定命令式中位置、否定句冠词变 de、社科环境保护长篇。', 60, false),
  buildAuthenticFullPaper(136, 'kaoyan', '名校考研二外', '武汉大学', '2022精编卷',
    '2022年武汉大学 二外法语考研真题精编卷',
    'Université de Wuhan (WHU) — Épreuve officielle de français 2022',
    '武大2022经典试题：先将来时与将来时态呼应、连词短语触发虚拟式、长篇论说文。', 60, false),

  buildAuthenticFullPaper(137, 'kaoyan', '名校考研二外', '复旦大学', '2024精编卷',
    '2024年复旦大学 二外法语考研真题精编卷',
    'Université Fudan (FDU) — Examen officiel de français langue étrangère 2024',
    '复旦二外权威题库：考查词汇广度、自反代词配合陷阱、复杂关系从句以及科技伦理阅读。', 60, false),
  buildAuthenticFullPaper(138, 'kaoyan', '名校考研二外', '复旦大学', '2023精编卷',
    '2023年复旦大学 二外法语考研真题精编卷',
    'Université Fudan (FDU) — Examen officiel de français langue étrangère 2023',
    '复旦2023真题：学术法语论述严谨性、条件式现在时表委婉请求、AI在教育中的角色长文。', 60, false),

  buildAuthenticFullPaper(139, 'kaoyan', '名校考研二外', '中山大学', '2024精编卷',
    '2024年中山大学 二外法语考研真题精编卷',
    'Université Sun Yat-sen (SYSU) — Examen de Master en français 2024',
    '中大高频试题：重点攻坚时间状语从句与时态呼应、否定句型变异及社科文化事实推论。', 60, false),
  buildAuthenticFullPaper(140, 'kaoyan', '名校考研二外', '中山大学', '2023精编卷',
    '2023年中山大学 二外法语考研真题精编卷',
    'Université Sun Yat-sen (SYSU) — Examen de Master en français 2023',
    '中大2023真题：愈过去时与过去分词配合、关系代词 dont 所有格、法国非遗饮食文化精读。', 60, false),

  // -----------------------------------------------------------------------
  // 五、全国高校考研二外统考大纲与名校综合冲刺 (7套)
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(141, 'kaoyan', '名校考研二外', '全国高校统考大纲', '2025高频冲刺',
  ...
  buildAuthenticFullPaper(142, 'kaoyan', '名校考研二外', '全国高校统考大纲', '2025高频冲刺',
  ...
  buildAuthenticFullPaper(143, 'kaoyan', '名校考研二外', '名校联考精选', '2024综合冲刺',
    '2024年全国名校考研二外法语综合冲刺精编卷 (A卷)',
    'Concours National de Master : Épreuve de synthèse avancée 2024 (Série A)',
    '整合全国多所985外语院校考研试题核心精华，全真模拟考场环境，自测提分利器。', 60, false),
  buildAuthenticFullPaper(144, 'kaoyan', '名校考研二外', '名校联考精选', '2024综合冲刺',
    '2024年全国名校考研二外法语综合冲刺精编卷 (B卷)',
    'Concours National de Master : Épreuve de synthèse avancée 2024 (Série B)',
    '针对易错混淆项设计干扰，深度攻克过去分词配合、副代词 en 的数量代换及长文主旨。', 60, false),
  buildAuthenticFullPaper(145, 'kaoyan', '名校考研二外', '名校联考精选', '2023综合冲刺',
    '2023年全国名校考研二外法语综合冲刺精编卷 (A卷)',
    'Concours National de Master : Épreuve de synthèse avancée 2023 (Série A)',
    '二外语法高频易失分点全景排雷：复合关系代词、否定词配对、条件假设。', 60, false),
  buildAuthenticFullPaper(146, 'kaoyan', '名校考研二外', '名校联考精选', '2023综合冲刺',
    '2023年全国名校考研二外法语综合冲刺精编卷 (B卷)',
    'Concours National de Master : Épreuve de synthèse avancée 2023 (Série B)',
    '名校联考压轴B卷：重点突击动词变位特异形态、长篇阅读主旨推理。', 60, false),
  buildAuthenticFullPaper(147, 'kaoyan', '名校考研二外', '全国高校统考大纲', '终极押题卷',
    '全国名校考研二外法语考前绝密押题终极精编卷',
    'Concours National de Master : Recueil ultime de simulation et pronostics',
    '考前最后一周必刷压轴大卷，查漏补缺，快速提升临场解题熟练度。', 60, false),

  // -----------------------------------------------------------------------
  // 六、大学法语四级考试 (CFT-4) 全国统考全真大卷系列 (10套)
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(201, 'cft4', '大学法语四级', '教育部高校外语统考', '2024全真卷',
    '2024年大学法语四级 (CFT-4) 全国统考全真大卷 (6月)',
    'Certificat de Français pour l\'Enseignement Supérieur (CFT-4 : Session 2024)',
    '完全遵循教育部《大学法语四级考试大纲》标准排版，覆盖听力理解、词汇语法、完形与阅读。', 45, true),
  buildAuthenticFullPaper(202, 'cft4', '大学法语四级', '教育部高校外语统考', '2023全真卷',
    '2023年大学法语四级 (CFT-4) 全国统考全真大卷 (6月)',
    'Certificat de Français pour l\'Enseignement Supérieur (CFT-4 : Session 2023)',
    '四级统考2023原题精编：代词式动词时态配合、日常生活情景交际、广播短文听解与事实提取。', 45, false),
  buildAuthenticFullPaper(203, 'cft4', '大学法语四级', '教育部高校外语统考', '2022全真卷',
    '2022年大学法语四级 (CFT-4) 全国统考全真大卷',
    'Certificat de Français pour l\'Enseignement Supérieur (CFT-4 : Session 2022)',
    '标准化考题分布，精准检验公外法语学员 A2-B1 水平阶段的核心语言综合运用能力。', 45, false),
  buildAuthenticFullPaper(204, 'cft4', '大学法语四级', '教育部高校外语统考', '2021全真卷',
    '2021年大学法语四级 (CFT-4) 全国统考全真大卷',
    'Certificat de Français pour l\'Enseignement Supérieur (CFT-4 : Session 2021)',
    '历年四级考纲核心汇编：现在时/复合过去时交替、地点与交通介词搭配、应用文阅读。', 45, false),
  buildAuthenticFullPaper(205, 'cft4', '大学法语四级', '教育部高校外语统考', '2020全真卷',
    '2020年大学法语四级 (CFT-4) 全国统考全真大卷',
    'Certificat de Français pour l\'Enseignement Supérieur (CFT-4 : Session 2020)',
    '四级统考高频考题：短语动词接格、直接宾语人称代词位置、火车站广播原声听解。', 45, false),
  buildAuthenticFullPaper(206, 'cft4', '大学法语四级', '教育部高校外语统考', '2019全真卷',
    '2019年大学法语四级 (CFT-4) 全国统考全真大卷',
    'Certificat de Français pour l\'Enseignement Supérieur (CFT-4 : Session 2019)',
    '四级经典考卷：测试词汇积累与完形语感，包含现代生活与环保出行短篇社科读解。', 45, false),
  buildAuthenticFullPaper(207, 'cft4', '大学法语四级', '教育部高校外语统考', '冲刺模拟卷',
    '大学法语四级 (CFT-4) 全国统考全真冲刺模拟卷 (一)',
    'CFT-4 : Modèle officiel de simulation intensive (Vol. 1)',
    '考前全真模拟实测，严格倒计时45分钟，自测全国高校四级统考过级概率。', 45, false),
  buildAuthenticFullPaper(208, 'cft4', '大学法语四级', '教育部高校外语统考', '冲刺模拟卷',
    '大学法语四级 (CFT-4) 全国统考全真冲刺模拟卷 (二)',
    'CFT-4 : Modèle officiel de simulation intensive (Vol. 2)',
    '全真命题题型配置，夯实语法与词汇基本盘，稳过全国四级及格线。', 45, false),
  buildAuthenticFullPaper(209, 'cft4', '大学法语四级', '教育部高校外语统考', '专项突破卷',
  ...
  buildAuthenticFullPaper(210, 'cft4', '大学法语四级', '教育部高校外语统考', '专项突破卷',
  ...
  // -----------------------------------------------------------------------
  // 八、考研二外 & DELF 四大考点专项攻坚大卷系列 (12套)
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(401, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
  ...
  buildAuthenticFullPaper(402, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
    '【专项突破】直宾间宾与副代词 y/en 双代词语序专练 (卷二)',
    'Module Spécialisé 1 : Pronoms personnels compléments et pronoms adverbiaux (Vol. 2)',
    '强化代词提前时的过去分词性数配合、否定句代词位置与多代词复杂句型。', 35, false),
  buildAuthenticFullPaper(403, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
    '【专项突破】关系代词 qui/que/dont/où 与中性代词专练 (卷一)',
    'Module Spécialisé 1 : Pronoms relatifs simples et composés (Vol. 1)',
    '系统梳理简单关系代词：dont 的所有格属性、où 的时空引申及中性代词 le 替代从句。', 35, false),
  buildAuthenticFullPaper(404, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
    '【专项突破】复合关系代词 auquel/lequel/duquel 专练 (卷二)',
    'Module Spécialisé 1 : Pronoms relatifs simples et composés (Vol. 2)',
    '攻克复合关系代词介词缩合规律 (auquel, desquels, dans laquelle) 及格位判定。', 35, false),
  buildAuthenticFullPaper(405, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
  ...
  buildAuthenticFullPaper(406, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
    '【专项突破】先将来时与将来时态系统配合专练 (卷二)',
    'Module Spécialisé 2 : Concordance des temps du passé et du futur (Vol. 2)',
    '掌握将来完成时态呼应 (dès que, quand, aussitôt que) 与不规则动词变位。', 35, false),
  buildAuthenticFullPaper(407, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
    '【专项突破】虚拟式触发从句与条件式假设用法专练 (卷一)',
    'Module Spécialisé 2 : Mode subjonctif et système hypothétique (Vol. 1)',
    '直击二外语法制高点：情感/意愿/怀疑/连词短语触发虚拟式，以及 Si 条件句三层假设系统。', 35, false),
  buildAuthenticFullPaper(408, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
    '【专项突破】主观情感/怀疑/连词短语触发虚拟式精练 (卷二)',
    'Module Spécialisé 2 : Mode subjonctif approfondi (Vol. 2)',
    '辨析 bien que, avant que, pour que, à condition que 等虚拟式连词的高频命题陷阱。', 35, false),
  buildAuthenticFullPaper(409, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
  ...
  buildAuthenticFullPaper(410, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
  ...
  buildAuthenticFullPaper(411, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
  ...
  buildAuthenticFullPaper(412, 'drill', '专项攻坚', '法语教研组权威研发', '考点突破卷',
 ...
 * 赛道 3：【🌍 法国官方 DELF 欧标考级 (A1-B2)】终身认证真题精编卷 (14套)
 * 赛道 4：【⚡ 考研二外 & DELF 四大专项攻坚大卷】重难点考点突破 (12套)
 */
