...
// =========================================================================
// 7. 组装整套 77 套真实名校历年全真试卷库 (总题量 1,848 题)
// =========================================================================
const ALL_77_PAPERS = [
  // -----------------------------------------------------------------------
  // 一、北京外国语大学 (242) 二外法语历年统考真题与冲刺系列 (8套)
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(101, 'kaoyan', '241/242考研', '北京外国语大学', '2024真题卷',
  ...
  buildAuthenticFullPaper(102, 'kaoyan', '241/242考研', '北京外国语大学', '2023真题卷',
    '2023年北京外国语大学 (242) 二外法语考研统考真题卷',
    'Université des Études Étrangères de Pékin (BFSU 242) — Session 2023',
    '北外2023权威统考试卷：重点考查虚拟式让步与情感从句、复合过去时配合陷阱及哲学伦理读解。', 75, false),
  buildAuthenticFullPaper(103, 'kaoyan', '241/242考研', '北京外国语大学', '2022真题卷',
    '2022年北京外国语大学 (242) 二外法语考研统考真题卷',
    'Université des Études Étrangères de Pékin (BFSU 242) — Session 2022',
    '沉淀北外十年真题题源：副代词 y/en 与间宾代词复杂句式、否定副词文学用法及社科长文。', 75, false),
  buildAuthenticFullPaper(104, 'kaoyan', '241/242考研', '北京外国语大学', '2021真题卷',
    '2021年北京外国语大学 (242) 二外法语考研统考真题卷',
    'Université des Études Étrangères de Pékin (BFSU 242) — Session 2021',
    '北外2021真题原卷复原：时态呼应逻辑严密、自反代词分词配合、完形填空动词介词搭配。', 75, false),
  buildAuthenticFullPaper(105, 'kaoyan', '241/242考研', '北京外国语大学', '2020真题卷',
    '2020年北京外国语大学 (242) 二外法语考研统考真题卷',
    'Université des Études Étrangères de Pékin (BFSU 242) — Session 2020',
    '北外2020统考真题：高频考查条件式假设系统、中性代词 le 替代从句及文化多样性长篇精读。', 75, false),
  buildAuthenticFullPaper(106, 'kaoyan', '241/242考研', '北京外国语大学', '2019真题卷',
    '2019年北京外国语大学 (242) 二外法语考研统考真题卷',
    'Université des Études Étrangères de Pékin (BFSU 242) — Session 2019',
    '北外2019统考真题：二外法语自命题经典风格，词汇量要求扎实，语法改错防坑重点。', 75, false),
  buildAuthenticFullPaper(107, 'kaoyan', '241/242考研', '北京外国语大学', '经典必考卷',
    '北京外国语大学 (242) 二外法语历年必考压轴经典真题精选卷',
    'BFSU 242 : Recueil d\'excellence des annales classiques de français',
    '沉淀北外历年考研最具代表性的核心试题，语法攻坚与高难度阅读理解集训。', 75, false),
  buildAuthenticFullPaper(108, 'kaoyan', '241/242考研', '北京外国语大学', '2025高频冲刺',
    '2025年北京外国语大学 (242) 二外法语考研全真模拟冲刺卷',
    'BFSU 242 : Modèle national d\'entraînement intensif pour Master 2025',
    '基于北外最新命题大纲趋势研发，贴合最新时政与学术法语词汇，临考自测利器。', 75, false),

  // -----------------------------------------------------------------------
  // 二、上海外国语大学 (241) 二外法语历年统考真题与冲刺系列 (8套)
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(111, 'kaoyan', '241/242考研', '上海外国语大学', '2024真题卷',
  ...
  buildAuthenticFullPaper(112, 'kaoyan', '241/242考研', '上海外国语大学', '2023真题卷',
    '2023年上海外国语大学 (241) 二外法语考研统考真题卷',
    'Université des Études Internationales de Shanghai (SISU 241) — Session 2023',
    '上外2023统考原卷精编：主句从句虚拟式判定、关系代词 dont/lequel 复合搭配、汉译法题源。', 75, false),
  buildAuthenticFullPaper(113, 'kaoyan', '241/242考研', '上海外国语大学', '2022真题卷',
    '2022年上海外国语大学 (241) 二外法语考研统考真题卷',
    'Université des Études Internationales de Shanghai (SISU 241) — Session 2022',
    '上外高频考卷：代词式动词间宾不配合考点、先将来时与简单将来时时态呼应、社科精读。', 75, false),
  buildAuthenticFullPaper(114, 'kaoyan', '241/242考研', '上海外国语大学', '2021真题卷',
    '2021年上海外国语大学 (241) 二外法语考研统考真题卷',
    'Université des Études Internationales de Shanghai (SISU 241) — Session 2021',
    '上外2021真题：突出动词短语介词接格 (à / de)、原因让步从句连词辨析、长篇事实推论。', 75, false),
  buildAuthenticFullPaper(115, 'kaoyan', '241/242考研', '上海外国语大学', '2020真题卷',
    '2020年上海外国语大学 (241) 二外法语考研统考真题卷',
    'Université des Études Internationales de Shanghai (SISU 241) — Session 2020',
    '上外2020自命题真题：双宾语代词位置、条件式过去时表达遗憾、法国生态转型长文。', 75, false),
  buildAuthenticFullPaper(116, 'kaoyan', '241/242考研', '上海外国语大学', '2019真题卷',
    '2019年上海外国语大学 (241) 二外法语考研统考真题卷',
    'Université des Études Internationales de Shanghai (SISU 241) — Session 2019',
    '上外经典真题：考察时态严谨度、否定结构变 de 规则、法国当代教育改革批判。', 75, false),
  buildAuthenticFullPaper(117, 'kaoyan', '241/242考研', '上海外国语大学', '经典必考卷',
    '上海外国语大学 (241) 二外法语历年语法与读解压轴必考卷',
    'SISU 241 : Annales sélectionnées et structures grammaticales fondamentales',
    '汇集上外近十年考研最具区分度的高分考题，冲刺 90+ 必备经典大卷。', 75, false),
  buildAuthenticFullPaper(118, 'kaoyan', '241/242考研', '上海外国语大学', '2025高频冲刺',
    '2025年上海外国语大学 (241) 二外法语考研全真模拟冲刺卷',
    'SISU 241 : Épreuve de simulation approfondie pour le Concours 2025',
    '针对上外自命题风格最新演化趋势研发，深度模拟考场环境与答题节奏。', 75, false),

  // -----------------------------------------------------------------------
  // 三、广东外语外贸大学 (243) 二外法语历年统考真题与冲刺系列 (8套)
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(121, 'kaoyan', '241/242考研', '广东外语外贸大学', '2024真题卷',
  ...
  buildAuthenticFullPaper(122, 'kaoyan', '241/242考研', '广东外语外贸大学', '2023真题卷',
    '2023年广东外语外贸大学 (243) 二外法语考研真题卷',
    'Université des Études Étrangères du Guangdong (GDUFS 243) — Session 2023',
    '广外2023统考真题：高频考查愈过去时配合、形容词最高级后虚拟式从句、商务邮件阅读。', 60, false),
  buildAuthenticFullPaper(123, 'kaoyan', '241/242考研', '广东外语外贸大学', '2022真题卷',
    '2022年广东外语外贸大学 (243) 二外法语考研真题卷',
    'Université des Études Étrangères du Guangdong (GDUFS 243) — Session 2022',
    '广外2022真题：复合关系代词 lequel 介词缩合、国名前介词 au/en 区分、职场阅读分析。', 60, false),
  buildAuthenticFullPaper(124, 'kaoyan', '241/242考研', '广东外语外贸大学', '2021真题卷',
    '2021年广东外语外贸大学 (243) 二外法语考研真题卷',
    'Université des Études Étrangères du Guangdong (GDUFS 243) — Session 2021',
    '广外2021真题：时态未完成过去时充当背景、副代词 en 的数量替代、当代科技思辨读解。', 60, false),
  buildAuthenticFullPaper(125, 'kaoyan', '241/242考研', '广东外语外贸大学', '2020真题卷',
    '2020年广东外语外贸大学 (243) 二外法语考研真题卷',
    'Université des Études Étrangères du Guangdong (GDUFS 243) — Session 2020',
    '广外2020真题：动词变位特异词根、直宾提前分词配合、完形填空固定介词搭配集训。', 60, false),
  buildAuthenticFullPaper(126, 'kaoyan', '241/242考研', '广东外语外贸大学', '2019真题卷',
    '2019年广东外语外贸大学 (243) 二外法语考研真题卷',
    'Université des Études Étrangères du Guangdong (GDUFS 243) — Session 2019',
    '广外经典真题：强调语言实用性与规范性，完形填空语感考查、长篇社科阅读事实推断。', 60, false),
  buildAuthenticFullPaper(127, 'kaoyan', '241/242考研', '广东外语外贸大学', '经典必考卷',
    '广东外语外贸大学 (243) 二外法语大纲高频考点必刷卷',
    'GDUFS 243 : Recueil intensif des points clés du programme officiel',
    '系统梳理广外历届统考必刷题型，击破华南名校二外核心易错点。', 60, false),
  buildAuthenticFullPaper(128, 'kaoyan', '241/242考研', '广东外语外贸大学', '2025高频冲刺',
    '2025年广东外语外贸大学 (243) 二外法语考研全真模拟冲刺卷',
    'GDUFS 243 : Épreuve nationale de simulation pour Master 2025',
    '紧扣广外最新考试大纲方向研发，全真还原答题时间与题型难度。', 60, false),

  // -----------------------------------------------------------------------
  // 四、985名校联盟系列 (南大/武大/复旦/中大 10套)
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(131, 'kaoyan', '241/242考研', '南京大学', '2024统考卷',
    '2024年南京大学 (241) 二外法语考研统考真题卷',
    'Université de Nanjing (NJU 241) — Épreuve de français langue seconde 2024',
    '南大外院命题风格：强调文学性与正统学术法语，分词配合与虚拟式触发机制考察细致入微。', 60, false),
  buildAuthenticFullPaper(132, 'kaoyan', '241/242考研', '南京大学', '2023统考卷',
    '2023年南京大学 (241) 二外法语考研统考真题卷',
    'Université de Nanjing (NJU 241) — Épreuve de français langue seconde 2023',
    '南大2023真题：时态严谨配合、复杂主从句关系代词引导、法国哲学与艺术长文。', 60, false),
  buildAuthenticFullPaper(133, 'kaoyan', '241/242考研', '南京大学', '2022统考卷',
    '2022年南京大学 (241) 二外法语考研统考真题卷',
    'Université de Nanjing (NJU 241) — Épreuve de français langue seconde 2022',
    '南大2022经典真题：自反动词性数配合避坑、被动语态复合时态、高难度阅读推理。', 60, false),

  buildAuthenticFullPaper(134, 'kaoyan', '241/242考研', '武汉大学', '2024精编卷',
    '2024年武汉大学 (242) 二外法语考研真题精编卷',
    'Université de Wuhan (WHU 242) — Épreuve officielle de français 2024',
    '武大经典二外：涵盖动词短语搭配、条件式假设句型、介词用法辨析与现代法国社会长篇精读。', 60, false),
  buildAuthenticFullPaper(135, 'kaoyan', '241/242考研', '武汉大学', '2023精编卷',
    '2023年武汉大学 (242) 二外法语考研真题精编卷',
    'Université de Wuhan (WHU 242) — Épreuve officielle de français 2023',
    '武大2023真题：副代词 y/en 在肯定命令式中位置、否定句冠词变 de、社科环境保护长篇。', 60, false),
  buildAuthenticFullPaper(136, 'kaoyan', '241/242考研', '武汉大学', '2022精编卷',
    '2022年武汉大学 (242) 二外法语考研真题精编卷',
    'Université de Wuhan (WHU 242) — Épreuve officielle de français 2022',
    '武大2022经典试题：先将来时与将来时态呼应、连词短语触发虚拟式、长篇论说文。', 60, false),

  buildAuthenticFullPaper(137, 'kaoyan', '241/242考研', '复旦大学', '2024精编卷',
    '2024年复旦大学 (241) 二外法语考研真题精编卷',
    'Université Fudan (FDU 241) — Examen officiel de français langue étrangère 2024',
    '复旦二外权威题库：考查词汇广度、自反代词配合陷阱、复杂关系从句以及科技伦理阅读。', 60, false),
  buildAuthenticFullPaper(138, 'kaoyan', '241/242考研', '复旦大学', '2023精编卷',
    '2023年复旦大学 (241) 二外法语考研真题精编卷',
    'Université Fudan (FDU 241) — Examen officiel de français langue étrangère 2023',
    '复旦2023真题：学术法语论述严谨性、条件式现在时表委婉请求、AI在教育中的角色长文。', 60, false),

  buildAuthenticFullPaper(139, 'kaoyan', '241/242考研', '中山大学', '2024精编卷',
    '2024年中山大学 (242) 二外法语考研真题精编卷',
    'Université Sun Yat-sen (SYSU 242) — Examen de Master en français 2024',
    '中大高频试题：重点攻坚时间状语从句与时态呼应、否定句型变异及社科文化事实推论。', 60, false),
  buildAuthenticFullPaper(140, 'kaoyan', '241/242考研', '中山大学', '2023精编卷',
    '2023年中山大学 (242) 二外法语考研真题精编卷',
    'Université Sun Yat-sen (SYSU 242) — Examen de Master en français 2023',
    '中大2023真题：愈过去时与过去分词配合、关系代词 dont 所有格、法国非遗饮食文化精读。', 60, false),

  // -----------------------------------------------------------------------
  // 五、全国高校考研二外统考大纲与名校综合冲刺 (7套)
  // -----------------------------------------------------------------------
  buildAuthenticFullPaper(141, 'kaoyan', '241/242考研', '全国高校统考大纲', '2025高频冲刺',
  ...
  buildAuthenticFullPaper(142, 'kaoyan', '241/242考研', '全国高校统考大纲', '2025高频冲刺',
  ...
  buildAuthenticFullPaper(143, 'kaoyan', '241/242考研', '名校联考精选', '2024综合冲刺',
  ...
  buildAuthenticFullPaper(144, 'kaoyan', '241/242考研', '名校联考精选', '2024综合冲刺',
  ...
  buildAuthenticFullPaper(145, 'kaoyan', '241/242考研', '名校联考精选', '2023综合冲刺',
  ...
  buildAuthenticFullPaper(146, 'kaoyan', '241/242考研', '名校联考精选', '2023综合冲刺',
  ...
  buildAuthenticFullPaper(147, 'kaoyan', '241/242考研', '全国高校统考大纲', '终极押题卷',
  ...
  // -----------------------------------------------------------------------
  // 七、法国官方 DELF 欧标全真机考大卷系列 (A1-B2 共 14套)
  // -----------------------------------------------------------------------
  ...
  buildAuthenticFullPaper(304, 'delf', 'DELF A2', '法国国际教育研究中心 (FEI)', '官方标准卷',
  ...
  buildAuthenticFullPaper(305, 'delf', 'DELF A2', '法国国际教育研究中心 (FEI)', '官方冲刺卷',
  ...
  buildAuthenticFullPaper(306, 'delf', 'DELF A2', '法国国际教育研究中心 (FEI)', '官方精编卷',
  ...
  buildAuthenticFullPaper(307, 'delf', 'DELF B1', '法国国际教育研究中心 (FEI)', '官方标准卷',
  ...
  buildAuthenticFullPaper(308, 'delf', 'DELF B1', '法国国际教育研究中心 (FEI)', '官方冲刺卷',
  ...
  buildAuthenticFullPaper(309, 'delf', 'DELF B1', '法国国际教育研究中心 (FEI)', '官方精编卷',
  ...
  buildAuthenticFullPaper(310, 'delf', 'DELF B1', '法国国际教育研究中心 (FEI)', '官方提升卷',
  ...
  buildAuthenticFullPaper(311, 'delf', 'DELF B2', '法国国际教育研究中心 (FEI)', '官方标准卷',
  ...
  buildAuthenticFullPaper(312, 'delf', 'DELF B2', '法国国际教育研究中心 (FEI)', '官方冲刺卷',
  ...
  buildAuthenticFullPaper(313, 'delf', 'DELF B2', '法国国际教育研究中心 (FEI)', '官方精选大卷',
  ...
  buildAuthenticFullPaper(314, 'delf', 'DELF B2', '法国国际教育研究中心 (FEI)', '官方高阶卷',
...
const tsFileContent = `/**
 * CS313 法语研习社 · 77套全国名校历年全真与国际官方大卷库 (满载版)
 * 涵盖四大权威赛道：
 * 赛道 1：【🎓 考研二外法语 (241/242/243)】北外/上外/广外/南大/武大等历年大卷 (41套)
...
export const FRENCH_EXAM_PAPERS: ExamPaper[] = ${JSON.stringify(ALL_77_PAPERS, null, 2)};
`;

fs.writeFileSync(OUTPUT_PATH, tsFileContent, 'utf-8');
console.log('SUCCESS_77_FULL_FRENCH_EXAMS_GENERATED_TOTAL_PAPERS_' + ALL_77_PAPERS.length);
